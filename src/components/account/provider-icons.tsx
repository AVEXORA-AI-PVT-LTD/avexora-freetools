/**
 * Official brand marks for the authentication provider buttons.
 *
 * These are the canonical vector marks (Google "G", Facebook "f") used by the
 * providers' own brand guidelines — not emoji or lookalike glyphs. No icon
 * library is installed in this project, so an inline SVG is the correct source
 * rather than pulling a dependency in for two logos.
 */
