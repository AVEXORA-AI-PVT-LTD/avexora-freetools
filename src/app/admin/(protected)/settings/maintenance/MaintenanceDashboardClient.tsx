    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <button
          ...
          disabled={loading}
          className="inline-flex items-center gap-2 px-3.5 py-2 rounded-lg bg-zinc-100 dark:bg-zinc-800 text-zinc-700 dark:text-zinc-200 text-xs font-semibold hover:bg-zinc-200 transition-colors self-start sm:self-center"
        >
      ...
      {loading ? (
        <div className="flex items-center justify-center p-12 bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-2xl">
          <Loader2 className="h-6 w-6 animate-spin text-orange-600 mr-2" />
          <span className="text-sm text-zinc-500 font-medium">Loading system maintenance diagnostics...</span>
        </div>
      ) : (
        <>
          {/* System Status Grid */}
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
              {[
                ...
                return (
                  <div
                    key={i}
                    className="p-4 rounded-xl bg-zinc-50 dark:bg-zinc-800/50 border border-zinc-200/80 dark:border-zinc-800 flex flex-col items-start"
                  >
            ...
            <div className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-2xl p-6 shadow-sm flex flex-col justify-between">
              <div>
                <div className="flex items-center justify-between mb-4">
                  ...
                  <span className="text-xs font-mono bg-zinc-100 dark:bg-zinc-800 px-2 py-0.5 rounded text-zinc-600">
                ...
                {summary?.latestBackup ? (
                  <div className="space-y-2 text-sm">
                    <div className="flex justify-between py-1 border-b border-zinc-100 dark:border-zinc-800">
                      ...
                      <span className="font-mono text-xs font-semibold">{summary.latestBackup.id}</span>
                    </div>
                    <div className="flex justify-between py-1 border-b border-zinc-100 dark:border-zinc-800">
                    ...
                    <div className="flex justify-between py-1">
                      <span className="text-zinc-500">Checksum Status:</span>
                  ...
                  <p className="text-xs text-zinc-500 py-4">No completed backups found.</p>
                )}
              </div>
            ...
            <div className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-2xl p-6 shadow-sm flex flex-col justify-between">
              <div>
                ...
                <div className="space-y-2 text-sm">
                  ...
                  <div className="py-1">
                    <span className="text-zinc-500 block mb-1">Visitor Message:</span>
                    <p className="text-xs italic bg-zinc-50 dark:bg-zinc-800 p-2 rounded border border-zinc-200 dark:border-zinc-700 text-zinc-700 dark:text-zinc-300">
          ...
          <div className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-2xl p-6 shadow-sm">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
              ...
              <button
                ...
                className="p-4 rounded-xl border border-zinc-200 dark:border-zinc-800 hover:border-orange-300 text-left transition-all hover:shadow-md cursor-pointer flex items-center gap-3 bg-zinc-50/50"
              >
                ...
                <div>
                  <h4 className="font-bold text-sm text-zinc-900 dark:text-zinc-100">Create Backup</h4>
                  <p className="text-xs text-zinc-500">Export database snapshot</p>
                </div>
              </button>
              ...
              >
                ...
                <div>
                  <h4 className="font-bold text-sm text-zinc-900 dark:text-zinc-100">Clear Cache</h4>
                  <p className="text-xs text-zinc-500">Invalidate app cache</p>
                </div>
              </button>
              ...
              >
                ...
                <div>
                  <h4 className="font-bold text-sm text-zinc-900 dark:text-zinc-100">Re-index Data</h4>
                  <p className="text-xs text-zinc-500">Rebuild collection indexes</p>
                </div>
              </button>
              ...
              >
                ...
                <div>
                  <h4 className="font-bold text-sm text-zinc-900 dark:text-zinc-100">Rebuild Sitemap</h4>
                  <p className="text-xs text-zinc-500">Generate XML sitemap</p>
                </div>
              </button>
              ...
              >
                ...
                <div>
                  <h4 className="font-bold text-sm text-zinc-900 dark:text-zinc-100">Health Check</h4>
                  <p className="text-xs text-zinc-500">Test latency & connections</p>
                </div>
              </button>
              ...
              >
                ...
                <div>
                  <h4 className="font-bold text-sm text-zinc-900 dark:text-zinc-100">Maintenance Mode</h4>
                  <p className="text-xs text-zinc-500">Toggle public site access</p>
                </div>
              </Link>
            </div>
          </div>
