...
export const tools: ToolConfig[] = [
  {
    ...
    steps: [
      "Select Image — Choose the image you want to compress from your device.",
      "Adjust Quality — Move the quality slider (80% is a great starting point for photos).",
      "Compare Size — Check the estimated new size compared to the original.",
      "Download — Save your optimized image instantly."
    ],
    faq: [
      {
  ...
  },
  {
    ...
    steps: [
      "Upload Photo — Select the image you need to resize.",
      "Set Dimensions — Enter your target width or height (keep the lock on to maintain proportions).",
      "Preview — Review the new dimensions and scaled image.",
      "Download — Save your perfectly sized image."
    ],
    faq: [
      {
  ...
  },
  {
    ...
    steps: [
      "Select Image — Open the photo you want to crop.",
      "Draw Crop Area — Click and drag over the part of the image you want to keep.",
      "Adjust Selection — Redraw the box if needed to get the perfect frame.",
      "Crop & Save — Click crop to trim the edges and download the result."
    ],
    faq: [
      {
  ...
  },
  {
    ...
    steps: [
      "Upload PNG — Select the PNG image you want to convert.",
      "Automatic Conversion — The tool instantly flattens any transparency and converts it to JPG.",
      "Download JPG — Save the new, smaller JPG file to your device."
    ],
    faq: [
      {
  ...
  },
  {
    ...
    steps: [
      "Select JPG — Choose the JPG file you need to convert.",
      "Process — The tool losslessly encodes your JPG pixels into the PNG format.",
      "Download PNG — Save your new PNG file, ready for editing."
    ],
    faq: [
      {
  ...
  },
  {
    ...
    steps: [
      "Select File — Upload a JPG, PNG, or other standard image file.",
      "Convert — The browser's built-in encoder transforms it into WebP.",
      "Download — Save your lightweight WebP image for web use."
    ],
    faq: [
      {
  ...
  },
  {
    ...
    steps: [
      "Select Image — Choose the image you want to encode.",
      "Convert — The tool instantly generates the Base64 text string.",
      "Copy Code — Click to copy the full data URL to your clipboard.",
      "Paste — Insert the string into your HTML src attribute or CSS."
    ],
    faq: [
      {
  ...
  },
  {
    ...
    steps: [
      "Paste String — Paste your Base64 text or full data URL.",
      "Decode — The tool instantly renders the image on screen.",
      "Verify — Check that the image looks correct and isn't corrupted.",
      "Download — Save the decoded visual as a standard image file."
    ],
    faq: [
      {
  ...
  },
  {
    ...
    steps: [
      "Upload Logo — Select a square, high-contrast image (like a symbol or letter).",
      "Generate — The tool instantly creates a complete set of resized PNGs.",
      "Download — Save the individual icons you need.",
      "Copy Code — Grab the provided HTML snippets to add to your site."
    ],
    faq: [
      {
  ...
  },
  {
    ...
    steps: [
      "Upload Image — Select the photo, screenshot, or mockup.",
      "Click to Sample — Click anywhere on the image to sample the pixel color.",
      "Review Value — See the exact Hex and RGB values displayed.",
      "Copy — Click to copy the Hex code to your clipboard."
    ],
    faq: [
      {
  ...
  },
  {
    ...
    steps: [
      "Upload Image — Select the photo that needs fixing.",
      "Rotate or Flip — Choose your rotation angle (90, 180, 270) or flip direction.",
      "Preview — Check that the new orientation looks correct.",
      "Download — Save the corrected image back to your device."
    ],
    faq: [
      {
  ...
  },
  {
    ...
    steps: [
      "Upload Photo — Select an image with a clear subject (people, pets, or products work best).",
      "AI Processing — Wait a few moments while the on-device AI analyzes and isolates the subject.",
      "Preview Cutout — Review the transparent result to ensure the edges are clean.",
      "Download PNG — Save the image with true alpha transparency."
    ],
    faq: [
      {
