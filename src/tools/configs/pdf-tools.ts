...
export const tools: ToolConfig[] = [
  ...
  },
  {
    ...
    related: ["word-to-pdf-converter", "pdf-page-remover", "reorder-pdf-pages", "compress-pdf"],
  },
  {
    kind: "file-tool",
    ...
    related: ["pdf-to-word-converter", "merge-pdf", "compress-pdf", "add-page-numbers-to-pdf"],
  },
  {
    kind: "file-tool",
